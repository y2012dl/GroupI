1. Execution
PyMUS v2.0 is optimized for Windows 7 and 8.1. The Main Window of PyMUS v2.0 can be launched by running the executable file of "PyMUS.exe" depending on the version of your operating system (32-bit or 64-bit).
